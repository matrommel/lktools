...
Public Class frmSettings
    ...
    Private Sub FrmSettings_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        chkGraphAsPicture.Checked = LKTool.GraphAsPicture
    ...
    Private Sub UpdateVariables()
        ...
        LKTool.GraphAsPicture = chkGraphAsPicture.Checked
    ...
    Private Sub UpdateXML()
        ...
        If xDoc.load(LKTool.myFile) Then
            ...
            point.selectSingleNode("//GraphAsPicture").text = chkGraphAsPicture.Checked
